...
/** @type {string} */
const CACHE_VERSION = '1774348112|665481203';
/** @type {string} */
const CACHE_PREFIX = 'HiShell-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'HiShell.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["HiShell.html","HiShell.js","HiShell.offline.html","HiShell.icon.png","HiShell.apple-touch-icon.png","HiShell.audio.worklet.js","HiShell.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["HiShell.wasm","HiShell.pck"];
